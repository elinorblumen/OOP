...
/**
 * Class representing an "abs" type sort object.
 * Sorts file names by their absolute name.
 */
public class MergeSortAbs implements SortFiles{

    //*** Data members ***//

    private boolean isReverseSuffix;

    /**
     * Constructor for MergeSortAbs.
     * @param reverseSuffix A boolean value that indicates whether the reverse suffix
     *                      was added.
     */
    public MergeSortAbs(boolean reverseSuffix){
